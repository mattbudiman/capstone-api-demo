...
--CALLS--
INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (1, 1, 1, 'Hello', ( 'positive', ( 0.80, 0.10 , 0.10) ) );


INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (2, 1, 2, 'Youre disgusting, I hate you, I want to kill you, give me two hundred dollars', ( 'negative', ( 0.10, 0.10 , 0.80) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (3, 1, 3, 'This was an alright call.', ( 'neutral', ( 0.25, 0.60 , 0.15) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (4, 1, 4, 'This was a mixed call.', ( 'neutral', ( 0.33, 0.34 , 0.33) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (5, 1, 5, 'I had a great time this evening.', ( 'positive', ( 0.90, 0.05 , 0.05) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (6, 1, 6, 'The truth may be stretched thin, but it never breaks, and it always surfaces above lies, as oil floats on water', ( 'neutral', ( 0.20, 0.75 , 0.05) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (7, 1, 7, 'They were conquerors, and for that you want only brute force--nothing to boast of, when you have it, since your strength is just an accident arising from the weakness of others', ( 'neutral', ( 0.20, 0.75 , 0.05) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (8, 1, 8, 'Theres some good in this world, Mr. Frodo… and its worth fighting for', ( 'positive', ( 0.70, 0.20 , 0.10) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (9, 1, 9, 'The end justifies the means. But what if there never is an end? All we have is means.', ( 'positive', ( 0.73, 0.14 , 0.13) ) );
...
INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (11, 2, 1, 'Whenever you feel like criticizing any one, just remember that all the people in this world havent had the advantages that youve had.', ( 'positive', ( 0.70, 0.20 , 0.10) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (12, 3, 2, 'Life is like a box of chocolates, you never know what youre gonna get', ( 'neutral', ( 0.20, 0.68 , 0.12) ) );

INSERT INTO calls(id, agent_id, customer_id, transcript, sentiment)
VALUES (13, 10, 3, 'Reflect upon your present blessings -- of which every man has many -- not on your past misfortunes, of which all men have some.', ( 'neutral', ( 0.90, 0.08 , 0.02) ) );
